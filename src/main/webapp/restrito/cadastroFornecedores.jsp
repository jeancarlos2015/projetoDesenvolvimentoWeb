...
<html lang="pt-br">
    ...
    <body class="newsletter bg-grey ">
        ...
        <section class="container paracima_meio">
            <h1 class="bg-titulo-white">CADASTRO DE FORNECEDORES</h1>
            <form method="post" action="../Controlador">

                <input class="bg-white radius campo" type="text"  name="nome" placeholder="Nome do fornecedor" required>
                <input class="bg-white radius campo" type="text"  name="cnpj" placeholder="CNPJ" required>
                <input class="bg-white radius campo" type="text"  name="telefone" placeholder="Telefone do fornecedor" required>
                <input class="bg-white radius campo" type="text"  name="endereco" placeholder="Endereço do fornecedor" required>
                
                <input class="oculto" type="text" value="fornecedor"  name="tipo">
            ...
            <div class="alert centralizar">
                <h3 class="mensagem">${mensagem_fornecedor}</h3>
            </div>
        </section>
        <!-- RODAPÉ -->
