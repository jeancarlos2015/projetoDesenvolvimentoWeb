    ...
    <body>
        ...
        <section class="newsletter container bg-grey">
            ...
            <form method="post" action="Controlador">
                ...
                <button type="submit" class="bg-white radius campo"> Solicitacoes De Pedidos </button>
            </form>
            <form method="post" action="Controlador">
                <input class="oculto" type="text" value="cliente"  name="tipo">
                <input class="oculto" type="text" value="cadastro"  name="operacao">
                <button type="submit" class="bg-white radius campo"> Monitoramento De Pedidos </button>
            </form>
